...
public class FastFibonacci {
    ...
    public static void main(String[] args) throws RunnerException {
        int fibonacciIndex = 10000;

        // Do speed benchmark
        long startTime;

        startTime = System.nanoTime();
        BigInteger x = fastFibonacciDoubling(fibonacciIndex);
        System.out.printf("Fast doubling: %d ms%n", (System.nanoTime() - startTime) / 1000000);

        startTime = System.nanoTime();
        BigInteger y = fastFibonacciMatrix(fibonacciIndex);
        System.out.printf("Fast matrix: %d ms%n", (System.nanoTime() - startTime) / 1000000);

        startTime = System.nanoTime();
        BigInteger z = slowFibonacci(fibonacciIndex);
